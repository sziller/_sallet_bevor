...
if __name__ == "__main__":
    ...
    keys_to_add = \
        [{"alias": 'mAIn', "owner": "sziller.eu", "features": "nope", "is_rpc": True,
         ...
         {"alias": 'blockchain.info', "owner": "blockchain.com", "features": "N/A", "is_rpc": False,
          'ip': '0.0.0.0', 'port': 0, "desc": "kulso infoforras"},
         {"alias": 'Alap', "owner": "node.eu", "features": "N/A", "is_rpc": False,
          'ip': '0.0.0.0', 'port': 0, "desc": "testcucc"},
         ]

    session = SQLi.createSession(db_fullname=os.getenv("DB_PATH_BEVOR"), style=os.getenv("DB_STYLE_BEVOR"),
